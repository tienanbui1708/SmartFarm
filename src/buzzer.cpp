...
My_ToneTypeDef tones_5beep[] = {{4000, 8},  // Higher frequency and slightly longer duration
                                {0, 10},    // Pause
...
My_ToneTypeDef single_beep[] = {{1500, 3},  // Higher frequency and slightly longer duration
                                {0, 0}};

My_ToneTypeDef tones_2_beep[] = {{1200, 6},  // Lower frequency
                                 {0, 3},     // Short pause
                                 {1200, 6},  // Lower frequency
                                 {0, 9},     // Longer pause
                                 {0, 0}};

My_ToneTypeDef tones_SMB[] = {{2637, 18}, {0, 9},    {2637, 9},  {0, 9},     {2093, 9},  {2637, 9}, {0, 9},    {3136, 9},  {0, 27},    {1586, 9},  {0, 27},
                              {2093, 9},  {0, 18},   {1586, 9},  {0, 18},    {1319, 9},  {0, 18},   {1760, 9}, {0, 9},     {1976, 9},  {0, 9},     {1865, 9},
                              {1760, 9},  {0, 9},    {1586, 12}, {2637, 12}, {3136, 12}, {3520, 9}, {0, 9},    {2794, 9},  {3136, 9},  {0, 9},     {2637, 9},
                              {0, 9},     {2093, 9}, {2349, 9},  {1976, 9},  {0, 18},    {2093, 9}, {0, 18},   {1586, 9},  {0, 18},    {1319, 9},  {0, 18},
                              {1760, 9},  {0, 9},    {1976, 9},  {0, 9},     {1865, 9},  {1760, 9}, {0, 9},    {1586, 12}, {2637, 12}, {3136, 12}, {3520, 9},
                              {0, 9},     {2794, 9}, {3136, 9},  {0, 9},     {2637, 9},  {0, 9},    {2093, 9}, {2349, 9},  {1976, 9},  {0, 0}};

My_ToneTypeDef tones_startup[] = {{2000, 3}, {0, 3}, {3000, 3}, {0, 3}, {4000, 3}, {0, 3}, {1200, 4}, {0, 6}, {4500, 6}, {0, 0}};

My_ToneTypeDef tones_turnoff[] = {{2000, 3}, {0, 3}, {3000, 3}, {0, 3}, {4000, 3}, {0, 3}, {1200, 4}, {0, 6}, {4500, 6}, {0, 0}};

My_ToneTypeDef tones_3beep[] = {{4000, 3}, {0, 10}, {1000, 6}, {0, 10}, {4000, 3}, {0, 0}};
